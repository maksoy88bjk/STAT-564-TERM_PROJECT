...
scale_color_manual(name=" ",values = c("Actual" = "dodgerblue",
                   ...
                   labels = c("Actual", "Forecasts")) +
labs(x="Date",y="Precipitation (mm)") + 
  theme(legend.position = c(.9,.8)) +ggtitle("Forecasts of Precipitation by using SVR Model")
...
scale_color_manual(name=" ",values = c("Actual" = "dodgerblue",
                   ...
                   labels = c("Actual", "Forecasts")) +
labs(x="Date",y="Precipitation (mm)") + 
  theme(legend.position = c(.9,.8))+ggtitle("Forecasts of Precipitation by using GBM")
